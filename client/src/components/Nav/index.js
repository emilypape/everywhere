    ...
    <div className='mb-7'>
      <div className='flex mt-4 justify-between'>
        ...
        <div className='flex mr-3 '>
          <h1 className='cursor-pointer text-black font-medium p-3' onClick={() => setShowModal2(true)}>Signup</h1>
          <h1 className='cursor-pointer text-black font-medium p-3' onClick={() => setShowModal(true)}>Login</h1>
          {showModal ? (
            <>
